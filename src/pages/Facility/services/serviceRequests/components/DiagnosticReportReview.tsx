...
interface DiagnosticReportReviewProps {
  ...
  /**
   * The single report this review card displays. Parents that have multiple
   * reports should render one DiagnosticReportReview per report so the same
   * single-report rendering is looped, not forked into a multi-report layout.
   */
